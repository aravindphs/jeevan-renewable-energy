...
var ReactOdometer = ({ animation, duration, format, theme, value, ...rest }) => {
  const node = (0, import_react.useRef)(null);
  const odometer = (0, import_react.useRef)();
  (0, import_react.useEffect)(() => {
    odometer.current = new import_odometer.default({
      el: node.current,
      auto: false,
      animation,
      duration,
  ...
  (0, import_react.useEffect)(() => {
    var _a;
    (_a = odometer.current) == null ? void 0 : _a.update(value);
  }, [value]);
...
var dist_default = ReactOdometer;
export {
  dist_default as default
};
//# sourceMappingURL=react-odometerjs.js.map
